...
class Lecturer(db.Model):
    ...
    courses = db.relationship("Course", secondary="lecturer_course", backref=db.backref("lecturer"))
    attendance_sessions = db.relationship("Attendance", backref=db.backref('lecturer'), uselist=True)
