...
class Student(db.Model):
    ...
    courses = db.relationship('Course', secondary=course_students, lazy='subquery',
        backref=db.backref('student', lazy=True))
    attendances = db.relationship('Attendance', secondary=student_attendances, backref='student')
