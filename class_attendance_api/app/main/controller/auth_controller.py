...
@api.route('/lecturer/logout')
class LecturerLogoutAPI(Resource):
    """
    Lecturer Logout Resource
    """
...
@api.route('/student/logout')
class StudentLogoutAPI(Resource):
    """
    Student Logout Resource
    """
